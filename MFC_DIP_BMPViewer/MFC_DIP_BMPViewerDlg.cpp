...
// MFC_DIP_BMPViewerDlg.cpp: 实现文件
//

#include "pch.h"
#include "framework.h"
#include "MFC_DIP_BMPViewer.h"
#include "MFC_DIP_BMPViewerDlg.h"
...
CMFCDIPBMPViewerDlg::CMFCDIPBMPViewerDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MFC_DIP_BMPVIEWER_DIALOG, pParent)
{
...
// CMFCDIPBMPViewerDlg 消息处理程序

BOOL CMFCDIPBMPViewerDlg::OnInitDialog()
{
...
void CMFCDIPBMPViewerDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMFCDIPBMPViewerDlg::OnPaint()
{
	if (IsIconic())
	{
...
//显示。
HCURSOR CMFCDIPBMPViewerDlg::OnQueryDragIcon()
{
